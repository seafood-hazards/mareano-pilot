...
![](./image/mareano_slim.webp){.zoomable}
...
The site table stores unique geographic locations, keyed on latitude and longitude rounded to three decimal places, and depth.
