 ...
 * [pilot_mareano.tsv.gz](https://github.com/seafood-hazards/pilot-db-with-mareano/releases/download/v0.1.13/pilot_mareano.tsv.gz)
...
exported_columns_tbl <- tibble(
  ...
  `Source Table` = c(
    ...
    "Sample", "Sample",
    "Parameter", "Parameter / Sediment", "Sediment", "Sediment", "LLD"
  ),
  `Description` = c(
