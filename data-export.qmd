 ...
 * [pilot_mareano.tsv.gz](https://github.com/seafood-hazards/mareano-pilot/releases/download/v0.1.4/pilot_mareano.tsv.gz)
...
exported_columns_tbl <- tibble(
  ...
  `Source Table` = c(
    ...
    "Sample", "Sample",
    "Parameter", "Parameter / Sediment", "Sediment", "Sediment", "LLD", "Parameter (Categorized)"
  ),
  `Description` = c(
    ...
    "Lower limits of detection (LLD) value",
    "efsa: EFSA elements, other: Other elements, tcs: Total sulfur and carbon"
  )
)
